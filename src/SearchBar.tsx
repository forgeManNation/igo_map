...
import myJson from "./countryInfo.json"

const SearchBar = () => {

  let index = myJson.findIndex(x => x.continent ==="Europe");
  
  let myArr = []

  let europeanCountries = myJson.filter(countryData => {
  ...
  return (
    <div className= "bg-gray-800 h-screen overflow-scroll" style={{scrollbarColor: "#999 #333"}} >
        ...
        <div>{europeanCountries.map((element, index) => {
