    ...
    <>
      ...
      <Transition.Root show={props.open} as={Fragment}>
        <Dialog
          ...
          onClose={props.triggerIntroductionModal}
        >
          <Transition.Child
            as={Fragment}
                    ...
                    <div className="sm:flex sm:items-start">
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <p className="text-base leading-relaxed text-gray-900 dark:text-gray-400">
                          Dear visitor, this webpage was created to showcase
                          various IGOs (inter-governmental organisations)
                          <hr className="my-4" />
                          ...
                          in the year 2020 and may be obsolete or incomplete, if
                          that is the case you can help us update these data by
                          filling form in edit button
                          <hr className="my-4" />
