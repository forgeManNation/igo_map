...
const spinningWheelIcon = <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
  ...
  return (
    <div>
      ...
      <p className=' text-gray-300 bg-gradient-to-b flex justify-center  from-slate-900 to-slate-800  rounded-sm p-7'>{wikipediaFetchedText !== "" ? wikipediaFetchedText : spinningWheelIcon } 
      </p>
    </div>
  )
}
