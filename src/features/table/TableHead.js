...
const TableHead = () => {
    ...
    const deleteHypothesisIcon =  <span style={{ color: "red"}}>DELETE</span>
                ...
                <tr>
                    ...
                    {tableHeadData.map((tableHeadUpperRowCell, index) => {
                        ...
                        return <th key={tableHeadUpperRowCell + index} >
                                ...
                                <InformationIconAndPopover index = {index}></InformationIconAndPopover>
                                &nbsp;
                                ...
                                <span role="button" onClick = {() => dispatch(deleteSpecifiedHypothesis(index))} id = {"informationPopover" + index } >
