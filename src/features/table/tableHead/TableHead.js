     ...
     <thead>
                <tr>
                    ...
                    {tableHeadData.map((tableHeadUpperRowCell, index) => {
                        ...
                        return <th key={tableHeadUpperRowCell + index} >
                                ...
                                {tableHeadUpperRowCell.information ? <InformationIconAndPopover index = {index}></InformationIconAndPopover> : <></>}
                                &nbsp;
                                {/* button to edit information about hypothesis */}
                                <EditHypothesisIconAndModal name = {tableHeadUpperRowCell.name} information = {tableHeadUpperRowCell.information} index = {index}></EditHypothesisIconAndModal> 
                                &nbsp;
                                {/* button to delete hypothesis */}
                            
                                <span role="button" className='animate__animated animate__infinite  animate__pulse' onClick = {() => dispatch(deleteSpecifiedHypothesis(index))} id = {"informationPopover" + index } >
