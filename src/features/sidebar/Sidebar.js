...
const Sidebar = () => {
  ...
  const analysis = ["first", "second", "and the third"]


console.log("log me the user :)", user);

  return (
    <div class="main d-flex flex-column flex-shrink-0 p-3 text-dark " style={{width: "280px", height: "100%"}}>
    ...
    <span>
    this is where the data should be stored    
    </span>
